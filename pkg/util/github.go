...
// DoUpdate который извлекает двоичные файлы + контрольные суммы, опубликованные в github с помощью goreleaser.
// Он заканчивается заменой запущенного исполняемого файла, загружает и запускает его для отображения строки новой версии.
//  Думаю, это можно считать горячей заменой.
// https://github.com/FuzzyMonkeyCo/monkey/blob/master/main.go
// func DoUpdate() int {
